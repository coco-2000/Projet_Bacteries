...
std::string const BACTERIA_DIVISION = "division bacteria";
std::string const MEAN_DIVISION = "number of division per bacteria";
...
std::string const NUTRIMENT = "nutriment";
std::string const NUTRIMENT_A = "nutriment A";
std::string const NUTRIMENT_B = "nutriment B";
std::string const POISON = "poison";
