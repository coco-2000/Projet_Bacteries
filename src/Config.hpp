...
public:
    ...
    const int poison_min_qty;
    const int poison_max_qty;
    const double poison_resistance_factor;
    const double poison_toxic_factor;

    //bacteries
    const double simplebact_min_energy;
    const double simplebact_max_energy;
    const double simplebact_min_radius;
    const double simplebact_max_radius;
    const std::string simplebact_tumble_algo;

    const double swarmbact_min_energy;
    ...
    const double twitchingbact_min_radius;
    const double twitchingbact_max_radius;
    ...
    const double poisonbact_min_radius;
    const double poisonbact_max_radius;
